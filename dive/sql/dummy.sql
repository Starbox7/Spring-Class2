...
CREATE TABLE Shipper (
  ShipperID bigint PRIMARY KEY AUTO_INCREMENT,
...
ALTER TABLE Orders ADD FOREIGN KEY (CustomerID) REFERENCES Customer (CustomerID) ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE Orders ADD FOREIGN KEY (EmployeeID) REFERENCES Employee (EmployeeID);

ALTER TABLE Orders ADD FOREIGN KEY (ShipperID) REFERENCES Shipper (ShipperID);

ALTER TABLE Order_detail ADD FOREIGN KEY (OrderID) REFERENCES Orders (OrderID) ON DELETE CASCADE ON UPDATE NO ACTION;
